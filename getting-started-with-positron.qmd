...
If you are using Windows, you should see an option for "Git Bash," but only after you complete all the tasks in this chapter and restart Positron. 

Wth luck, Git Bash will also be the default every time you open the Terminal on Windows. But, if that does not work, you should select it by hand.
