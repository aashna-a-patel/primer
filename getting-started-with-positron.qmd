...
2.  Download and install [Positron](https://positron.posit.co/download.html). Note that the version you install must be at 2025.05.0-58, which is available [here](https://github.com/posit-dev/positron/releases/tag/2025.05.0-58). **This is important.** If you use an older version, then you won't be able to run multiple Consoles, which is necessary for completing tutorials.
