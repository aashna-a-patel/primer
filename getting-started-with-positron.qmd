...
`set_positron_settings()` makes some senisble changes to your Positron settings file and to your `.Rprofile`.
...
Let's install three other packages: **positron.tutorials**, **r4ds.tutorials** and **primer.tutorials**. Copy and paste the following to the R Console:
