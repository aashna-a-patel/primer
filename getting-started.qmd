...
If you are using Windows, you should see an option for "Git Bash" (or maybe just "bash"), at least if your have installed RTools as we told you to do above. If you did, and you don't see a bash option, try restarting Positron.
...
Again, this is only useful for Windows users. But they should click on that tool and select the option that says "bash" or something like it. This should set it as the default going forward.
